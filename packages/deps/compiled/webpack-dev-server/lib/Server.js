...
const fs = require("@fe6/biu-deps/compiled/fs-extra");
const ipaddr = require("@fe6/biu-deps/compiled/ipaddr.js");
const defaultGateway = require("@fe6/biu-deps/compiled/default-gateway");
const express = require("@fe6/biu-deps/compiled/express");
const { validate } = require("@fe6/biu-deps/compiled/schema-utils");
...
class Server {
  ...
  static async getFreePort(port) {
    ...
    const pRetry = require("@fe6/biu-deps/compiled/p-retry");
  ...
  addAdditionalEntries(compiler) {
    ...
    if (this.options.hot === "only") {
      additionalEntries.push(require.resolve("@fe6/biu-deps/compiled/webpack/hot/only-dev-server"));
    } else if (this.options.hot) {
      additionalEntries.push(require.resolve("@fe6/biu-deps/compiled/webpack/hot/dev-server"));
    }

    const webpack = compiler.webpack || require("@fe6/biu-deps/compiled/webpack");
  ...
  setupMiddlewares() {
    ...
    if (this.options.historyApiFallback) {
      const connectHistoryApiFallback = require("@fe6/biu-deps/compiled/connect-history-api-fallback");
  ...
  openBrowser(defaultOpenTarget) {
    const open = require("@fe6/biu-deps/compiled/open");
  ...
  runBonjour() {
     ...
     */
    this.bonjour = require("@fe6/biu-deps/compiled/bonjour")();
   ...
   */
  logStatus() {
    const { isColorSupported, cyan, red } = require("@fe6/biu-deps/compiled/colorette");
