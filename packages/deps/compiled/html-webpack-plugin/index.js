...
const _ = __nccwpck_require__(23);
  ...
  */
  ...
  function getFullTemplatePath (template, context) {
    ...
    if (template.indexOf('!') === -1) {
      template = path.join(__dirname, './loader.js') + '!' + path.resolve(context, template);
    }
...
const PrettyError = __nccwpck_require__(913);
...
const AsyncSeriesWaterfallHook = (__nccwpck_require__(921).AsyncSeriesWaterfallHook);
...
"use strict";
module.exports = require("@fe6/biu-deps/compiled/lodash");
...
"use strict";
module.exports = require("@fe6/biu-deps/compiled/pretty-error");
...
"use strict";
module.exports = require("@fe6/biu-deps/compiled/tapable");
