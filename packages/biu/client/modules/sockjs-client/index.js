...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['SockJS'] = factory();
  else root['SockJS'] = factory();
  ...
  \*************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          )(transportList); // TODO can't get rid of this until all servers do
  ...
  \**************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          var iframeUtils = __webpack_require__(
          ...
          SockJS.prototype._connect = function () {
            for (
              ...
              if (Transport.needBody) {
                if (
                  !__webpack_require__.g.document.body ||
                  (typeof __webpack_require__.g.document.readyState !==
                    'undefined' &&
  ...
  \***********************************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          if (axo in __webpack_require__.g) {
            try {
              HtmlfileReceiver.htmlfileEnabled = !!new __webpack_require__.g[
                axo
              ]('htmlfile');
            } catch (x) {
              // intentionally empty
  ...
  \********************************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          function JsonpReceiver(url) {
            ...
            __webpack_require__.g[utils.WPrefix][this.id] =
          ...
          JsonpReceiver.prototype._createScript = function (url) {
            ...
            var script = (this.script =
              __webpack_require__.g.document.createElement('script'));
            ...
            if (
              ...
              __webpack_require__.g.document.attachEvent
            ) {
            ...
            var head =
              __webpack_require__.g.document.getElementsByTagName('head')[0];
        ...
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          function createIframe(id) {
            ...
            try {
              ...
              return __webpack_require__.g.document.createElement(
                '<iframe name="' + id + '">',
              );
            } catch (x) {
              var iframe =
                __webpack_require__.g.document.createElement('iframe');
              iframe.name = id;
              return iframe;
            }
          }
  ...
  \****************************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          XDRObject.enabled = !!(
            __webpack_require__.g.XDomainRequest && browser.hasDomain()
          );
  ...
  \*********************************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          function /* method, url, payload, opts */
          XHRFake() {
            var self = this;
            EventEmitter.call(this);
  ...
  \****************************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          if (
            ...
            __webpack_require__.g.crypto.getRandomValues
          ) {
  ...
  \*******************************************************/
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          var onUnload = {},
            ...
            isChromePackagedApp =
              __webpack_require__.g.chrome &&
              __webpack_require__.g.chrome.app &&
              __webpack_require__.g.chrome.app.runtime;
          module.exports = {
            attachEvent: function attachEvent(event, listener) {
              if (
                typeof __webpack_require__.g.addEventListener !== 'undefined'
              ) {
                __webpack_require__.g.addEventListener(event, listener, false);
              } else if (
                __webpack_require__.g.document &&
                __webpack_require__.g.attachEvent
              ) {
                // IE quirks.
            ...
            detachEvent: function detachEvent(event, listener) {
              if (
                ...
                __webpack_require__.g.removeEventListener(
                  event,
                  listener,
                  false,
                );
                ...
                __webpack_require__.g.document &&
                __webpack_require__.g.detachEvent
              ) {
                __webpack_require__.g.document.detachEvent(
                  'on' + event,
                  listener,
                );
        ...
        /***/ function (module, __unused_webpack_exports, __webpack_require__) {
          ...
          module.exports = {
            ...
            postMessage: function postMessage(type, data) {
              if (__webpack_require__.g.parent !== __webpack_require__.g) {
                __webpack_require__.g.parent.postMessage(
                  JSON.stringify({
            ...
            createHtmlfile: function createHtmlfile(iframeUrl, errorCallback) {
              ...
              doc.write(
                '<html><s' +
                  'cript>' +
                  'document.domain="' +
                  __webpack_require__.g.document.domain +
                  '";' +
                  '</s' +
                  'cript></html>',
              );
          ...
          if (__webpack_require__.g.document) {
            ...
            module.exports.iframeEnabled =
              (typeof __webpack_require__.g.postMessage === 'function' ||
                typeof __webpack_require__.g.postMessage === 'object') &&
              !browser.isKonqueror();
          }
          ...
          ['log', 'debug', 'warn'].forEach(function (level) {
            ...
            try {
              levelExists =
                ...
                __webpack_require__.g.console[level] &&
                __webpack_require__.g.console[level].apply;
            } catch (e) {
              // do nothing
            }
            ...
            logObject[level] = levelExists
              ? function () {
                  return __webpack_require__.g.console[level].apply(
                    __webpack_require__.g.console,
                    arguments,
                  );
                }
  ...
  \**********************************************************************/
        /***/ function (module, exports, __webpack_require__) {
          ...
          module.exports = __webpack_require__(
            /*! ./common */ './node_modules/sockjs-client/node_modules/debug/src/common.js',
          )(exports);
  ...
  \***************************************************/
      ...
      /* harmony import */ var sockjs_client__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
          /*! sockjs-client */ './node_modules/sockjs-client/lib/entry.js',
        );
      /* harmony import */ var sockjs_client__WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          sockjs_client__WEBPACK_IMPORTED_MODULE_0__,
        );
